...
//D=51.7/1.5; // this printed fine
D= 51.7;
// thickness
//T=15/2; //this printed fine(con /4 se salía)
T=15/1.5;
// clearance
tol=0.25;//0.15; 0.1875  y 0.15*2.2
number_of_planets=4;
...
rotate ([90,90,0])
{	//difference ( ){
//		cube ( size=[w*1.305,w*1.305,15],center = true);
	difference (){
	//	Hex( radius = w*1.305/2, h= 15) ;
		translate ([0,0,15/2])
		cube ( size=[w*1.25,w*1.25,15], center = true);
		translate ([0,0,3])
		Hex( radius = w/2, h = 12);
	}
//}
